        <template>
            ...
            <section class="relative bg-layout-sun-50 text-layout-sun-900 dark:bg-layout-night-50 dark:text-layout-night-900 transition-colors duration-1000"  style='z-index:50;'>
                <!-- Header -->
                <nav id="navid" class="fixed top-0 left-0 right-0 z-30 bg-layout-sun-50 text-layout-sun-900 dark:bg-layout-night-50 dark:text-layout-night-900 border-b border-layout-sun-200 dark:border-layout-night-200"  style='z-index:50;'>
                <div class="container mx-auto max-w-6xl p-6 lg:flex lg:items-center lg:justify-between" style='z-index:50;'>
                    ...
                    <div class="flex flex-col items-center space-y-4 lg:mt-0 lg:flex-row lg:space-y-0 lg:space-x-3" style='z-index:10000000;'>
                        <link-header :route-name="route('home.index')" name="Home" :preserve-state="false" :preserve-scroll="false"></link-header>
                        ...
                        <template v-if="!$page.props.auth.user && !userStore.user.user_id" >
                        ...
                        <div class="ms-3 relative">
                                        <Dropdown align="right" width="72" v-if="$page.props.auth.user || userStore.user.user_id">
                                        <template #trigger>
                                            <button
                                                v-if="
                                            ...
                                            >
                                                <img
                                                    ...
                                                    :src="
                                                    GetProfileImagePath($page.props.auth.user?.profile_photo_url || userStore.user.profile_photo_url)"
                                                    :alt="
                                                        $page.props.userdata
                                                            .full_name
                                                    "
...
import IconLogin from "@/Application/Components/Icons/IconLogin.vue";
        ...
        data() {
            ...
            rights: {
                ...
                mcslpoints: 0,
                userdata: this.$page.props.userdata,
            };
        },
