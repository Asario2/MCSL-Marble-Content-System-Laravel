...
<body>
    ...
    <div width="570" align="center" style='max-width:570px' class="border">
    <table class="wrapper" width="100%" cellpadding="0" cellspacing="0" role="presentation" class='border'>
<tr>
<td align="center">
...
<table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation" class='border'>
{{ $header ?? '' }}
...
{{ $content }}
<span style='font-size:15px;'>{{ $signatur2 ?? '' }}</span>
