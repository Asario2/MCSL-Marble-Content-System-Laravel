<?php
    ...
    "Megapixel","view_table"=>"Anzeigen",'add_table'=>"Hinzufügen",'story_en'=>"Geschichte Englisch",'story'=>"Geschichte","edit_table"=>"Bearbeiten","publish_table"=>"Veröffentlichen","date_table"=>"Datum Ändern","delete_table"=>"Löschen","short_tag" => "Tag","exif_copyright" => "Exif copy","PrivateMessages"=>"Private Nachrichten",
    ...
    "us_poster"=>"Author","mail_body"=>"Text","xis_anzeige"=>"Anzeige","Contacts"=>"Kontakte","SendMailToAll"=>"An alle Nutzer senden","Statistics"=>"Zugriffsstatistiken","StatisticsAll"=>"Statistiken alle Domains"];
